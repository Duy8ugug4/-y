    ...
    while wait(.25) do
        if _G.Auto_Superhuman or _G.Auto_Fully_Superhuman and game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then 
			pcall(function()
				...
				if game.Players.LocalPlayer.Backpack:FindFirstChild("Leg") and game.Players.LocalPlayer.Backpack:FindFirstChild("Leg").Level.Value <= 299  then
					_G.Select_Weapon = "Leg"
				end
				...
				if game.Players.LocalPlayer.Backpack:FindFirstChild("Leg") and game.Players.LocalPlayer.Backpack:FindFirstChild("Leg").Level.Value >= 300  then
					local args = {
						[1] = "BuyFishmanKarate"
					}
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
				end
				if game.Players.LocalPlayer.Character:FindFirstChild("Leg") and game.Players.LocalPlayer.Character:FindFirstChild("Leg").Level.Value >= 300  then
					local args = {
						[1] = "BuyFishmanKarate"
					}
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
spawn(function()
	while wait() do
		if _G.Auto_Death_Step then
			if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") then
				if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leg") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leg").Level.Value >= 450 then
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
					_G.Select_Weapon = "Death Step"
				end  
				if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Leg") and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Leg").Level.Value >= 450 then
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
					_G.Select_Weapon = "Death Step"
				end  
				if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leg") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leg").Level.Value <= 449 then
					_G.Select_Weapon = "Leg"
				end 
			else 
...
spawn(function()
	while wait() do
		if _G.Auto_Fully_Death_Step then
			pcall(function()
				if not game.Players.LocalPlayer.Backpack:FindFirstChild("Leg") or not game.Players.LocalPlayer.Character:FindFirstChild("Leg") or not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") then
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
				end				
				if game:GetService("Workspace").Map.IceCastle.Hall.LibraryDoor.PhoeyuDoor.Transparency == 0 then  
					...
					elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Leg") and game.Players.LocalPlayer.Backpack:FindFirstChild("Leg").Level.Value >= 450 or game.Players.LocalPlayer.Character:FindFirstChild("Leg") and game.Players.LocalPlayer.Character:FindFirstChild("Leg").Level.Value >= 450 then   
...
if World2 then
 ...
 Shop:Button("Cape",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cape")
  end)
